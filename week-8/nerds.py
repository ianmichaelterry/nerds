...
class TitleParserNerd(Nerd):
    ...
    def can_run(self, bb: Blackboard) -> bool:
        return super().can_run(bb) and bb.has(NERDS.MovieData) and not bb.has(NERDS.TitleChunks)
...
class GenrePaletteNerd(Nerd):
    ...
    def can_run(self, bb: Blackboard) -> bool:
        return super().can_run(bb) and bb.has(NERDS.MovieData) and not bb.has(NERDS.ColorPalette)
...
class TypefaceNerd(Nerd):
    ...
    def can_run(self, bb: Blackboard) -> bool:
        return super().can_run(bb) and not bb.has(NERDS.Typeface)
...
class LayoutNerd(Nerd):
    ...
    def can_run(self, bb: Blackboard) -> bool:
        return super().can_run(bb) and not bb.has(NERDS.Layout)
...
class HeroImageNerd(Nerd):
    ...
    def can_run(self, bb: Blackboard) -> bool:
        return super().can_run(bb) and bb.has(NERDS.ColorPalette) and not bb.has(NERDS.HeroImage)
...
class IconNerd(Nerd):
    ...
    def can_run(self, bb: Blackboard) -> bool:
        return (super().can_run(bb) and bb.has(NERDS.MovieData)
                and bb.has(NERDS.ColorPalette) and not bb.has(NERDS.IconImage))
...
class GrainNerd(Nerd):
    ...
    def can_run(self, bb: Blackboard) -> bool:
        return super().can_run(bb) and bb.has(NERDS.HeroImage) and not bb.has(NERDS.PostEffect)
...
def make_all_nerds() -> list[Nerd]:
    ...
    return [
        ...
        IconNerd(name="IconFetcher", heat=Heat.HOT, cooldown_rate=99,
        ...
        CompletionNerd(name="CompletionJudge", heat=Heat.MEDIUM, cooldown_rate=1,
